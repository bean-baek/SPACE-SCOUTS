  ...
  items: {
    ...
    "cocktail-reward": [
      {
        ...
        desc: [
          "대장의 다양한 모습을 담은 아크릴 헤어핀 6종을 준비했어요!\n귀여운 분위기의 레터링, 일러스트, 사진 등\n여러 가지 스타일로 구성되어 있어,\n취향에 따라 즐겁게 골라볼 수 있습니다.",
          "머리 뿐 아니라 가방이나 파우치, 옷에 톡 달아\n스카우트 대원만의 센스로 일상 속 탐사 기분을 함께해 보세요.",
        ],
      },
    ],
    ...
    "lucky-draw": [
      ...
      },
      {
        ...
        desc: [
          "각기 다른 매력을 담은 핀 버튼 4종 세트를\n세 가지 색상으로 준비했어요!",
          "대원마다 마음에 드는 색을 골라\n가방이나 파우치, 대원복에 달고\n자신만의 개성을 마음껏 표현해 보세요.",
      ...
      },
      {
        ...
        desc: [
          ...
          "스페이스 스카우트 대원이라면\n우주 탐사를 떠날 때 절대 빼놓을 수 없는 필수품이겠죠?",
        ],
      },
    ],
